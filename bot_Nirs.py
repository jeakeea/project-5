...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("🔍 Поиск по направлению", callback_data='search_field')],
...
async def search_field(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.callback_query.message.reply_text(
        "Введите направление исследований для поиска:",
        reply_markup=reply_markup
    )
...
async def handle_search(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not advisors:
        ...
        await update.message.reply_text(
            f"Научных руководителей по направлению '{search_query}' не найдено.",
            reply_markup=reply_markup
        )
        return

    await update.message.reply_text(
        f"🔍 Результаты поиска по направлению '{search_query}':"
    )
...
• Поиск руководителей по направлению исследований
